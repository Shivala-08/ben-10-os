...
export function StatCards({ alienId }: { alienId: string }) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      <div className="bg-[var(--color-surface)] border border-[var(--color-primary)]/30 p-6 rounded-lg backdrop-blur-sm relative overflow-hidden group hover:border-[var(--color-primary)] transition-colors">
